...
import com.ortec.gta.shared.util.ReflectUtil;
...
public abstract class AbstractDAO<R extends CrudRepository<E, Long>, E, D> {
     ...
     */
    public AbstractDAO(Class<E> entityClass, Class<D> dtoClass) {
